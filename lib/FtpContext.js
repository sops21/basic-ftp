...
exports.FTPContext = class FTPContext {
     ...
     * @param {number} [controlTimeout=0] - Timeout in milliseconds to apply to control Use 0 for no timeout.
     */
    constructor(timeout = 0, encoding = "utf8", controlTimeout = 0) {
        /**
         ...
         * @type {number}
         */
        this._controlTimeout = controlTimeout;
        /**
    ...
    enableControlTimeout(enabled) {
        this.socket.setTimeout(enabled ? this._controlTimeout : 0);
    }
